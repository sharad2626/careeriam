...
<?php if (!empty($favicon)) : ?>
	...
	<!-- <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/create-job-style.css" type="text/css">
	<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/custom-create-job.css" type="text/css"> -->
