...
<head>     
  ...
  <!-- <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri().'/css/edit_profile_style.css';?>" type="text/css">
  <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri().'/css/edit_profile_custom.css';?>" type="text/css"> -->
  ...
  <!-- Slidebars CSS -->
  <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri().'/css/edit_profile_slidebars.css'; ?>" type="text/css">
  
      <?php if (!empty($favicon)) : ?>
	<link rel="shortcut icon" href="<?php echo $favicon; ?>" type="image/x-icon" />
  <?php endif; ?>
  <!-- <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri().'/css/edit_profile_small.css';?>" type="text/css">
  <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri().'/css/edit_profile_medium.css';?>" type="text/css">
  <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri().'/css/edit_profile_large.css';?>" type="text/css"> -->
...
<script src="http://ajax.aspnetcdn.com/ajax/jquery.validate/1.11.1/jquery.validate.min.js"></script>
	<script src="<?php echo get_stylesheet_directory_uri().'/js/edit_profile.js'; ?>"></script>
</head>  
<body>   
