					...
					<div class="resume-title acc-head">
					  <h4 class="acc-title">
						...
						<div class="title-label">
						  <span class="main-title">Edit Job Offer</span>
						  <span class="sub-desc">Hey. Its Easier than it looks. Take a deep breath and complete the fields below. You will have a beautifull Job Offer!</span>
						</div>
					  </h4>
					</div>
							...
							<span class="input">
							  <div class="code-editor wp-core-ui wp-editor-wrap tmce-active">
								...
								$settings = array(
										...
										//'quicktags' => true   
										//change the quicktag setting to display the visual and text editor
										'quicktags' => array(
                       'buttons' => ','
                    )
								);
						  ...
						  <span class="full">
							...
							<div class="up-cover up-photo">
							  <div class="default-img">
								...
								<img class="criteria-image" id="your_cover_url_img" src="<?php if (!empty($wpjobus_job_cover_image)) echo $wpjobus_job_cover_image; ?>" width="105" height="105"/>
