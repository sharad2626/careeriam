...
<?php if (!empty($favicon)) : ?>
	...
	<!-- <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/login-style.css" type="text/css"> -->
	<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/common-style.css" type="text/css">

	<!-- <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/custom2.css" type="text/css">
	<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/custom_resumes.css" type="text/css"> -->
...
<body class="inner-pages-black-header">   
