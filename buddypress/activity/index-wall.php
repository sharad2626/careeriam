...
<div id="buddypress"  class="company-header sections wall-section">
<div class="container">
						...
						<?php if ( is_user_logged_in() ) : ?>
							...
							<?php if ( bp_is_active( 'friends' ) ) : ?>
								...
								<?php if ( bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
									...
									<li id="activity-friends"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_friends_slug() . '/'; ?>" title="<?php _e( 'The activity of my friends only.', 'buddypress' ); ?>"><?php printf( __( 'My Associates Posts <span>%s</span>', 'buddypress' ), number_format_i18n( bp_get_total_friend_count( bp_loggedin_user_id() ) ) ); ?></a></li>
							...
							<?php if ( bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) ) : ?>
								...
								<li id="activity-favorites"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/favorites/'; ?>" title="<?php _e( "The activity I've liked.", 'bp-wall' ); ?>"><?php printf( __( 'My Likes <span>%s</span>', 'bp-wall' ), number_format_i18n( bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) ) ); ?></a></li>
